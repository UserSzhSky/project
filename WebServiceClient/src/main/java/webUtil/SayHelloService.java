 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://service.com/", wsdlLocation = "http://localhost:9091/Service/SayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://service.com/", "SayHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9091/Service/SayHello?wsdl");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://service.com/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "SayHelloPort"), SayHello.class, features);
    }
